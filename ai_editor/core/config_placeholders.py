...
ENV_SERVER_ID_SUFFIX = "AI_EDITOR_SERVER_ID_SUFFIX"
ENV_BIND_HOST = "AI_EDITOR_BIND_HOST"
ENV_PROTOCOL = "AI_EDITOR_PROTOCOL"
ENV_REGISTRATION_PROTOCOL = "AI_EDITOR_REGISTRATION_PROTOCOL"
ENV_REGISTRATION_SCHEME = "AI_EDITOR_REGISTRATION_SCHEME"
ENV_CODE_ANALYSIS_PROTOCOL = "AI_EDITOR_CODE_ANALYSIS_PROTOCOL"
ENV_SERVER_SSL_CERT = "AI_EDITOR_SERVER_SSL_CERT"
ENV_SERVER_SSL_KEY = "AI_EDITOR_SERVER_SSL_KEY"
ENV_SERVER_SSL_CA = "AI_EDITOR_SERVER_SSL_CA"
ENV_CLIENT_SSL_CERT = "AI_EDITOR_CLIENT_SSL_CERT"
ENV_CLIENT_SSL_KEY = "AI_EDITOR_CLIENT_SSL_KEY"
ENV_CLIENT_SSL_CA = "AI_EDITOR_CLIENT_SSL_CA"
...
PH_SERVER_ID_SUFFIX = f"${{{ENV_SERVER_ID_SUFFIX}}}"
...
# network; matches the current production topology (192.168.254.26). Override
# per-host when the proxy is reachable at a different address.
DEFAULT_REGISTRATION_HOST = "172.18.0.1"
# "-vvz" host suffix used on the current production host (192.168.254.26);
# override per-host when installing elsewhere.
DEFAULT_SERVER_ID_SUFFIX = "-vvz"
DEFAULT_BIND_HOST = "0.0.0.0"
DEFAULT_PROTOCOL = "https"
# Certificate paths as the container sees them. The host directory holding the mTLS
# material is mounted here; the package settings file carries the same defaults.
DEFAULT_MTLS_CONTAINER_DIR = "/app/mtls_certificates"
DEFAULT_SERVER_SSL_CERT = (
    f"{DEFAULT_MTLS_CONTAINER_DIR}/mtls_certificates/server/ai-editor-server.crt"
)
DEFAULT_SERVER_SSL_KEY = (
    f"{DEFAULT_MTLS_CONTAINER_DIR}/mtls_certificates/server/ai-editor-server.key"
)
DEFAULT_SERVER_SSL_CA = f"{DEFAULT_MTLS_CONTAINER_DIR}/mtls_certificates/ca/ca.crt"
DEFAULT_CLIENT_SSL_CERT = (
    f"{DEFAULT_MTLS_CONTAINER_DIR}/mtls_certificates/client/ai-editor.crt"
)
DEFAULT_CLIENT_SSL_KEY = (
    f"{DEFAULT_MTLS_CONTAINER_DIR}/mtls_certificates/client/ai-editor.key"
)
DEFAULT_CLIENT_SSL_CA = f"{DEFAULT_MTLS_CONTAINER_DIR}/mtls_certificates/ca/ca.crt"
...
_ENV_DEFAULTS: Dict[str, str] = {
    ...
    ENV_REGISTRATION_HOST: DEFAULT_REGISTRATION_HOST,
    ENV_SERVER_ID_SUFFIX: DEFAULT_SERVER_ID_SUFFIX,
    ENV_BIND_HOST: DEFAULT_BIND_HOST,
    ENV_PROTOCOL: DEFAULT_PROTOCOL,
    ENV_REGISTRATION_PROTOCOL: DEFAULT_PROTOCOL,
    ENV_REGISTRATION_SCHEME: DEFAULT_PROTOCOL,
    ENV_CODE_ANALYSIS_PROTOCOL: DEFAULT_PROTOCOL,
    ENV_SERVER_SSL_CERT: DEFAULT_SERVER_SSL_CERT,
    ENV_SERVER_SSL_KEY: DEFAULT_SERVER_SSL_KEY,
    ENV_SERVER_SSL_CA: DEFAULT_SERVER_SSL_CA,
    ENV_CLIENT_SSL_CERT: DEFAULT_CLIENT_SSL_CERT,
    ENV_CLIENT_SSL_KEY: DEFAULT_CLIENT_SSL_KEY,
    ENV_CLIENT_SSL_CA: DEFAULT_CLIENT_SSL_CA,
}
