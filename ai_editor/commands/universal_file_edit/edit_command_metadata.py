...
def get_universal_file_edit_metadata(cls: Type[Any]) -> Dict[str, Any]:
    ...
    return {
        ...
        "detailed_description": (
            ...
            "  CST node operations are addressed by node_id/node_ref; sibling insert uses\n"
            "  target_node_id plus position before|after. Move is supported for Python\n"
            "  CST nodes and expands to delete plus insert.\n"
            ...
            "Structured config (.json, .yaml, .yml, .ini, .cfg, .toml) operation fields:\n"
            ...
            "  For JSON/YAML replace or insert: value accepts JSON-compatible scalars, arrays, or objects.\n"
            "  INI values must be strings; TOML values must be TOML-compatible (null is invalid).\n"
            ...
            "  INI/TOML use the same node_ref/json_pointer and key/index addressing\n"
            "  contract as JSON/YAML; the handler preserves their source format.\n\n"
        ...
        "parameters": {
            ...
            "operations": {
                "description": (
                    ...
                    "  Structured config: {type, node_ref|short_id|json_pointer, value};\n"
